...
def load_config(exp_id):
    ...
    **************************************** Paths ****************************************
    ...
    ''' 
    cfg.dataset_path = '/cvlabsrc1/cvlab/datasets_udaranga/datasets/3d/Task03_Liver'
    ...
    ************************************************************************************************
    ...
    cfg.patch_shape = (64, 128, 128) 
    cfg.resolution = (1.5625, 1.5625, 10.0)
    # cfg.patch_shape = (128, 128, 128) 
