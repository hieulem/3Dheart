...
from data.Full_Heart.full_heart import Heart
...
def load_config(exp_id=None):
    ...
    **************************************** Paths ****************************************
    ...
    ''' 
    cfg.dataset_path = '/cvlabsrc1/cvlab/datasets_udaranga/datasets/3d/Full_Heart'
    ...
    ************************************************************************************************
    ...
    # cfg.patch_shape = (32, 272, 272) 
    # cfg.patch_shape = (32, 272, 208) 
    # cfg.patch_shape = (32, 320, 256) 
    cfg.ndims = 3 
